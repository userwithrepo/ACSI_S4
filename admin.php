...
{
    //AI exploit:
    //POST /../../../../../../PHP_Repos/userwithrepo.ACSI_S4/userwithrepo-ACSI_S4-69542bd/admin.php HTTP/1.1
    //Host: localhost
    ...
    //
    //f=%3Cscript%3Ealert%281%29%3C%2Fscript%3E
    //REOPEN: AI XSS issue #74, Medium, Cross-site Scripting, https://github.com/userwithrepo/ACSI_S4/issues/74, e00e0b49
    echo $_POST['f'];
}
