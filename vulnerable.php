...
{
	//VERIFY: AI SQL issue #162, High, SQL Injection, https://github.com/userwithrepo/ACSI_S4/issues/162, 3fe65cbb
	//AI exploit:
	...
	//VERIFY: AI XSS issue #163, Medium, Cross-site Scripting, https://github.com/userwithrepo/ACSI_S4/issues/163, 1504a08d
	//AI exploit:
	...
	//VERIFY: AI XSS issue #163, Medium, Cross-site Scripting, https://github.com/userwithrepo/ACSI_S4/issues/163, 5fbb627b
	//AI exploit:
	//GET /../../../../../../PHP_Repos/userwithrepo.ACSI_S4/userwithrepo-ACSI_S4-19a3a67/vulnerable.php?user_id=1&id=1 HTTP/1.1
	//Host: localhost
	//Accept-Encoding: identity
	//Connection: close
